...
{* Doesn't pass W3C validation for HTML5 <link rel="Top"  href={"/"|ezurl(} title="{$site_title}" /> *}
...
<link href={$pagedesign.data_map.rss_feed.data_text|ezurl(,full)} rel="alternate" type="application/rss+xml" title="RSS" />
{/if}
