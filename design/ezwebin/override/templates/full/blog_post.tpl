                        ...
                        <div class="content-view-full">
                            <div class="class-blog-post float-break">
                                ...
                                <div class="attribute-byline">
                                    ...
                                    <p class="tags"> {"Tags:"|i18n("design/ezwebin/full/blog_post")}
                                         {foreach $node.data_map.tags.content.keywords as $keyword}
                                             <a href={concat( $node.parent.url_alias, "/(tag)/", $keyword|rawurlencode )|ezurl} title="{$keyword}">{$keyword}</a>{delimiter},{/delimiter}
                                         {/foreach}
                                    </p>
                                </div>
                                ...
                                <div class="attribute-comments">
                                    <a {* name is not valid in HTML5 name="comments" *}id="comments"></a>
